...
- Có dòng hướng dẫn người dùng xem cách lấy API key bằng cách click vào link này để xem hướng dẫn: https://tinyurl.com/hdsdpmTHT
...
- **Nội dung bắt buộc**:
  ...
  - Link khóa học: `https://tinyurl.com/khoahocAI2025`
  - Thông tin liên hệ: Facebook (https://www.facebook.com/tranhoaithanhvicko/) và Zalo (0348296773).
- **Code mẫu**:
```tsx
      {/* Footer Promotion */}
